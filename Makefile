# This Makefile is for the HTML::FromArrayref extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/HTML/FromArrayref.pm]
#     AUTHOR => q[Nic Wolff <nic@angel.net>]
#     LICENSE => q[perl]
#     NAME => q[HTML::FromArrayref]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/HTML/FromArrayref.pm]
#     clean => { FILES=>q[HTML-FromArrayref-*] }
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = HTML::FromArrayref
NAME_SYM = HTML_FromArrayref
VERSION = 1.0
...
MAKE = make
FULLEXT = HTML/FromArrayref
BASEEXT = FromArrayref
PARENT_NAME = HTML
DLBASE = $(BASEEXT)
VERSION_FROM = lib/HTML/FromArrayref.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/HTML/FromArrayref.pm
...
TO_INST_PM = lib/.DS_Store \
	lib/HTML/FromArrayref.pm

PM_TO_BLIB = lib/HTML/FromArrayref.pm \
...
DISTNAME = HTML-FromArrayref
DISTVNAME = HTML-FromArrayref-1.0
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/HTML/FromArrayref.pm $(INST_MAN3DIR)/HTML::FromArrayref.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                HTML-FromArrayref' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             1.0' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            Output HTML described by a Perl data structure' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Output HTML described by a Perl data structure</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/HTML/FromArrayref.pm blib/lib/HTML/FromArrayref.pm \
